...
Personne::Personne() : m_nom("Sans Nom"), m_prenom("Sans Prenom"), m_age(0), m_profession("Sans Profession"),
    m_adresse("Chez Maman et Papa")
{
}
 Personne::Personne(string nom, string prenom, unsigned short age, string profession) : m_nom(nom),
    m_prenom(prenom), m_age(age), m_profession(profession), m_adresse("PARIS")
{
}
